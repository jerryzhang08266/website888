...
export default {
    ...
    */
    ...
    css: [
        ...
        'assets/css/specific-fixes.css', // 针对具体问题的修复样式
        'assets/css/global-optimizations.css', // 全局优化样式
    ...
    plugins: [
        ...
        { src: '@/plugins/text-overflow-fix', mode: 'client' }, // 基础文字溢出修复插件
        { src: '@/plugins/enhanced-text-overflow-fix', mode: 'client' } // 增强版文字溢出修复插件
    ],
